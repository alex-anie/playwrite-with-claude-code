...
This file records every prompt used to generate automated tests with an AI coding agent (Claude Code, GitHub Copilot Chat, or similar) connected to the Playwright MCP Server.
